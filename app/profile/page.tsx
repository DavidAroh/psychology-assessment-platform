...
import { Mail, Phone, MapPin, Award, Save, Edit, ArrowLeft, Home } from "lucide-react"
              ...
              <Card>
                <CardHeader className="text-center">
                  <Avatar className="w-24 h-24 mx-auto mb-4">
                    <AvatarImage src="/professional-doctor-avatar.png" alt={profile.name} />
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Your assessment and client metrics</CardDescription>
                </CardHeader>
                <CardContent>
