...
const mockNotifications = [
  {
    id: 1,
    type: "high-risk",
    title: "High-risk PHQ-9 assessment",
    message: "Client Sarah Johnson scored 22/27 - requires immediate attention",
    time: "5 minutes ago",
    unread: true,
  ...
  },
  {
    ...
    message: "Client Mike Davis completed GAD-7 assessment",
    time: "1 hour ago",
    unread: true,
    clientId: "mike-davis",
  ...
  },
  {
    ...
    message: "Schedule follow-up with Client Emma Wilson",
    time: "2 hours ago",
    unread: false,
